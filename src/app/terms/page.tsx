    ...
    return (
        <div className="info-page">
            ...
            <div className="info-page__content">
                ...
                <p>Clarix AI provides an AI-powered workspace that includes chat, image generation, document creation, code assistance, music composition, video editing, and other AI tools. The Service uses multiple specialized AI engines and automatically picks the best one for your task.</p>
