...
const SLIDE_MODELS = [
    { id: 'deepseek-v4-flash', name: 'Speed Engine', provider: 'Clarix', color: '#a78bfa', description: 'Fastest · budget friendly', credits: 1 },
    { id: 'gemini-2.5-flash', name: 'Flash Engine', provider: 'Clarix', color: '#4285f4', description: 'Super fast · most affordable', credits: 3 },
    { id: 'claude-sonnet-4.6', name: 'Pro Engine', provider: 'Clarix', color: '#e8915a', description: 'Great writing · clean layouts', credits: 5 },
    { id: 'gpt-5.5', name: 'Writer Engine', provider: 'Clarix', color: '#10a37f', description: 'Best structure & storytelling', credits: 15 },
];
