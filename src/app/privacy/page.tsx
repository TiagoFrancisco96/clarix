    ...
    return (
        <div className="info-page">
            ...
            <div className="info-page__content">
                ...
                <p>We do not sell your personal information. We share data only with the AI infrastructure providers that power your requests, and they are contractually prohibited from using this data for training.</p>
